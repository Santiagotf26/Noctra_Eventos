...
const FloatingWhatsApp = () => {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 h-14 rounded-full bg-[#25D366] text-white shadow-[0_0_25px_rgba(37,211,102,0.4)] hover:bg-[#20bd5a] hover:shadow-[0_0_35px_rgba(37,211,102,0.6)] transition-all group overflow-hidden"
    ...
    >
      ...
      <span className="font-bold tracking-wide text-sm pr-1 relative z-10">CONTÁCTANOS</span>
    </motion.a>
  );
};
