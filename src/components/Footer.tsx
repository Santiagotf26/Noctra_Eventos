        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#galeria" className="text-gray-400 hover:text-white transition-colors">Galería de Eventos</a></li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">
                  <a href="https://wa.me/573114971131" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    +57 311 497 1131
                  </a>
                </span>
              </li>
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-l-lg px-4 py-2 w-full focus:outline-none focus:border-primary text-gray-200 placeholder-gray-500"
              />
              <button 
                type="button" 
                className="bg-primary hover:bg-primary/80 transition-colors text-white px-4 py-2 rounded-r-lg font-medium"
              >
                Enviar
              </button>
            </form>
